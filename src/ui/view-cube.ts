...
class ViewCube extends Container {
    ...
    constructor(events: Events, args = {}) {
        ...
        const circle = (color: string, fill: boolean, text?: string) => {
            ...
            // radius, stroke and label all scaled to 60% of the original
            // 10/2/10 - the 40-unit axis arms below are deliberately unchanged,
            // so the gizmo keeps its reach and only the knobs shrink.
            ...
            if (text) {
                ...
                t.setAttribute('font-family', '\'Cascadia Mono\', \'JetBrains Mono\', Consolas, monospace');
