 ...
 */
class VoluLabChunkSource implements ChunkSource {
...
const createExportSource = (splats: Splat[], settings: SerializeSettings): { source: ChunkSource, pool: ChunkDataPool } | null => {
    const source = new VoluLabChunkSource(splats, settings);
 ...
 */
// Bridge splat-transform progress events to volulab's events.
